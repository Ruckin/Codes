...
waypoints = generate3AdmissibleWaypoints( ...
...
function waypoints = generate3AdmissibleWaypoints( ...
...
alpha_list = params.alpha0 * [1 0.7 0.4 0.2 0.1];
angle_list = deg2rad([-45 -30 -15 0 15 30 45]);
...
for wp = 1:max_wp
    ...
    if ~found
        warning('Waypoint %d not found – MAS boundary reached.', wp);
        break;
    end
end
end
